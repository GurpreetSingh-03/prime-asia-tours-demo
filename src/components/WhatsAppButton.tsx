...
export default function WhatsAppButton() {
  const whatsappUrl = 'https://wa.me/971558597360';
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] text-white rounded-full shadow-2xl flex items-center justify-center hover:bg-[#128C7E] transition-all duration-300 hover:scale-110 group cursor-pointer"
